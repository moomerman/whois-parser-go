...
func TransferName(name string) string {
	...
	name = strings.Replace(name, "primary name server", "name server", -1)
	name = strings.Replace(name, "secondary name server", "name server", -1)
	name = strings.Replace(name, "ns 1", "name server", -1)
	name = strings.Replace(name, "ns 2", "name server", -1)
	name = strings.Replace(name, "ns 3", "name server", -1)
	name = strings.Replace(name, "ns name 01", "name server", -1)
	name = strings.Replace(name, "ns name 02", "name server", -1)
	name = strings.Replace(name, "ns name 03", "name server", -1)
	name = strings.Replace(name, "ns name 04", "name server", -1)
	...
	name = strings.Replace(name, "dateregistered", "create", -1)
	...
	name = strings.Replace(name, "datelastupdate", "update", -1)
	...
	name = strings.Replace(name, "datebilleduntil", "expire", -1)
